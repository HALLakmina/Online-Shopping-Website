...
<html>
	<head>
		<title>User Men Trousers Page</title>
	...
	<body>
		...
		<div class="row05">
				<div class="column07">
					<center><table>
						<tr>
							<td><a href ="UserMenT-ShirtPage.php?user_name=<?php echo $user_name?>&user_id=<?php echo $user_id?>" class="a01" >T-Shirt</a></td>
							<td><a href ="UserMenTrousersPage.php?user_name=<?php echo $user_name?>&user_id=<?php echo $user_id?>" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;font-weight:bold;">Trousers</a></td>
						</tr>
					</table></center>
				</div>
		</div>
