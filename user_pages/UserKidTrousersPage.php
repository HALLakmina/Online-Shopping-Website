...
<html>
	<head>
		<title>User Kid's Trousers Page</title>
	...
	<body>
		...
		<div class="row05">
				<div class="column07">
					<center><table>
						<tr>
							<td ><a href ="UserKidT-ShirtPage.php?user_name=<?php echo $user_name?>&user_id=<?php echo $user_id?>" class="a01" >T-Shirt</a></td>
							<td><a href ="UserKidTrousersPage.php?user_name=<?php echo $user_name?>&user_id=<?php echo $user_id?>" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;font-weight:bold;">Trousers</a></td>
						</tr>
					</table></center>
				</div>
		</div>
                            ...
                            ?>
                                <form method="post" action="cart_item_connect.php" >
                                    <div class="column08">
										...
										<input type="hidden" name="page_name" value="UserKidTrousersPage"><br>
