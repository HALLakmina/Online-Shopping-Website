...
<html>
	<head>
		<title>User Women Blouse Page</title>
	...
	<body>
		...
		<div class="row05">
				<div class="column07">
					<center><table>
						<tr>
							<td ><a href ="UserWomenPageSkirt.php?user_name=<?php echo $user_name?>&user_id=<?php echo $user_id?>" class="a01" >Skirt</a></td>
							<td><a href ="UserWomenPageBlouse.php?user_name=<?php echo $user_name?>&user_id=<?php echo $user_id?>" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;font-weight:bold;">Blouse</a></td>
						</tr>
					</table></center>
				</div>
		</div>
                            ...
                            ?>
                                <form method="post" action="cart_item_connect.php" >
                                    <div class="column08">
										...
										<input type="hidden" name="page_name" value="UserWomenPageBlouse"><br>
