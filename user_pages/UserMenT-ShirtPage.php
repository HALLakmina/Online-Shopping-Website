...
<html>
	<head>
		<title>User Men T-Shirt Page</title>
	...
	<body>
				...
				<div class="column01">
					<center><table class="headLink">
						<tr>
							...
							<td><a href ="UserMenT-ShirtPage.php?user_name=<?php echo $user_name?>&user_id=<?php echo $user_id?>"class="a01" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;">Men's</a></td>
		...
		<div class="row05">
				<div class="column07">
					<center><table>
						<tr>
							<td ><a href ="UserMenT-ShirtPage.php?user_name=<?php echo $user_name?>&user_id=<?php echo $user_id?>" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;font-weight:bold;">T-Shirt</a></td>
							<td><a href ="UserMenTrousersPage.php?user_name=<?php echo $user_name?>&user_id=<?php echo $user_id?>" class="a01">Trousers</a></td>
						</tr>
					</table></center>
				</div>
		</div>
                            ...
                            ?>
                                <form method="post" action="cart_item_connect.php" >
                                    <div class="column08">
										...
										<input type="hidden" name="page_name" value="UserMenT-ShirtPage"><br>
