			...
			<div class="row01">
				...
				<div class="column01">
					<center><table class="headLink">
						<tr>
							...
							<td><a href ="ComenAboutUsPage.php"class="a01" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;">About Us</a></td>
				...
				<div class="column02">
					<table class="headLine02">
						<tr>
							<td><a href ="UserLoginPage.php" class="a02">Login/Register</a></td>
						</tr>
					</table>
				</div>
			</div>
