...
<html>
	<head>
		<title>Comen Men Trousers Page</title>
	...
	<body>
				...
				<div class="column01">
					<center><table class="headLink">
						<tr>
							...
							<td><a href ="ComenWomenBlousePage.php"class="a01">Women's</a></td>
							<td><a href ="ComenMenT-ShirtPage.php" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;">Men's</a></td>
		...
		<div class="row05">
				<div class="column07">
					<center><table>
						<tr>
							<td><a href ="ComenMenT-ShirtPage.php" class="a01" >T-Shirt</a></td>
							<td><a href ="ComenMenTrousersPage.php" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;font-weight:bold;">Trousers</a></td>
						</tr>
					</table></center>
				</div>
		</div>
