...
<html>
	<head>
		<title>Comen Kid's T-Shirt Page</title>
	...
	<body>
		...
		<div class="row05">
				<div class="column07">
					<center><table>
						<tr>
							<td ><a href ="ComenKidT-ShirtPage.php"  style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;font-weight:bold;">T-Shirt</a></td>
							<td><a href ="ComenKidTrousersPage.php" class="a01">Trousers</a></td>
						</tr>
					</table></center>
				</div>
		</div>
