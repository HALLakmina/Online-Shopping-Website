...
<html>
	...
	<body>
		...
		<div class="row02">
			<div class="column03" >
				<p class="line" style="font-size:55px;margin-left: 30px;">Women's Fashion</p><p style="font-size:30px;color:rgb(0, 0, 0);font-family: Calibri;margin-left: 30px;">A huge fashion collection for ever</p><p><a href="ComenWomenPageSkirt.php" class="a03" style="margin-left: 30px;">SHOP NOW</a></p>
			</div>
			<div class="column04">
				<div class="row03">
					<div class="column05" class="text01">
						<p class="line" style="margin-left: 30px;">Men's Fashion</p><p><a href="ComenMenT-ShirtPage.php" class="a03" style="margin-left: 30px;">SHOP NOW</a></p>
					</div>
				</div>
				<div class="row031">
					<div class="column06">
						<p class="line" style="margin-left: 30px;">Kid's Fashion<br></p><p><a href="ComenKidT-ShirtPage.php" class="a03" style="margin-left: 30px;">SHOP NOW</a></p>
					</div>
				</div>
			</div>
		</div>
