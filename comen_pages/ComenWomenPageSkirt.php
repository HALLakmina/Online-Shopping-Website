...
<html>
	<head>
		<title>Comen Women Skirt Page</title>
	...
	<body>
		...
		<div class="row05">
				<div class="column07">
					<center><table>
						<tr>
							<td ><a href ="ComenWomenPageSkirt.php" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;font-weight:bold;" >Skirt</a></td>
							<td><a href ="ComenWomenPageBlouse.php" class="a01">Blouse</a></td>
						</tr>
					</table></center>
				</div>
		</div>
