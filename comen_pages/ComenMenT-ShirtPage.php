...
<html>
	<head>
		<title>Comen Men T-Shirt Page</title>
	...
	<body>
		...
		<div class="row05">
				<div class="column07">
					<center><table>
						<tr>
							<td ><a href ="ComenMenT-ShirtPage.php" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;font-weight:bold;">T-Shirt</a></td>
							<td><a href ="ComenMenTrousersPage.php" class="a01">Trousers</a></td>
						</tr>
					</table></center>
				</div>
		</div>
