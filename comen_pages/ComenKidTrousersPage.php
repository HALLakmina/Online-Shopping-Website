...
<html>
	<head>
		<title>Comen Kid's Trousers Page</title>
	...
	<body>
				...
				<div class="column01">
					<center><table class="headLink">
						<tr>
							...
							<td><a href ="ComenKidT-ShirtPage.php"class="a01" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;">Kid's</a></td>
		...
		<div class="row05">
				<div class="column07">
					<center><table>
						<tr>
							<td ><a href ="ComenKidT-ShirtPage.php" class="a01" >T-Shirt</a></td>
							<td><a href ="ComenKidTrousersPage.php" style="font-size:30px;text-decoration: none;font-family:Calibri;color:red;font-weight:bold;">Trousers</a></td>
						</tr>
					</table></center>
				</div>
		</div>
